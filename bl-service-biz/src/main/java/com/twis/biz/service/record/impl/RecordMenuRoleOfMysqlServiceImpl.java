...
import com.twis.biz.dao.record.RecordMenuRoleOfMysqlDao;
...
import com.twis.model.BlMenuroleModel;

@Service
public class RecordMenuRoleOfMysqlServiceImpl implements RecordMenuRoleOfMysqlService {

	@Autowired
	private RecordMenuRoleOfMysqlDao recordMenuRoleOfMysqlDao;
	@Override
	public JsonResult insert(Map<String, Object> parameter) throws Exception {
		JsonResult jsonResult = new JsonResult();
		Map<String,Object> map = new HashMap<String,Object>();
		BlMenuroleModel model = new BlMenuroleModel();
		if (parameter.containsKey("id")) {
			model.setId(SqlUids.nextId());
		}
		int value = recordMenuRoleOfMysqlDao.insert(model, parameter);
		map.put("data",value);
	...
	public JsonResult update(Map<String, Object> parameter) throws Exception {
		...
		Map<String,Object> map = new HashMap<String,Object>();
		BlMenuroleModel model = new BlMenuroleModel();
		int value = recordMenuRoleOfMysqlDao.update(model, parameter);
		map.put("data",value);
		jsonResult.setData(map);
		jsonResult.setSuccess(true);
		return jsonResult;
	...
	public JsonResult delete(Map<String, Object> parameter) throws Exception {
		...
		Map<String,Object> map = new HashMap<String,Object>();
		BlMenuroleModel model = new BlMenuroleModel();
		int value = recordMenuRoleOfMysqlDao.delete(model, parameter);
		map.put("data",value);
		jsonResult.setData(map);
		jsonResult.setSuccess(true);
		return jsonResult;
	...
	public JsonResult query(Map<String, Object> parameter) throws Exception {
		...
		map.put("data",recordMenuRoleOfMysqlDao.query(model));
		jsonResult.setData(map);
		jsonResult.setSuccess(true);
		return jsonResult;
	}
	...
	public JsonResult queryNavigator(Map<String, Object> parameter) throws Exception {
		...
		map.put("data",recordMenuRoleOfMysqlDao.queryNavigator(model, parameter,currentPage,pageSize));
		jsonResult.setData(map);
		jsonResult.setSuccess(true);
		return jsonResult;
	}
