...
import com.twis.biz.dao.record.RecordTypeOfMysqlDao;
...
import com.twis.model.BlRecordtypeModel;

@Service
public class RecordTypeOfMysqlServiceImpl implements RecordTypeOfMysqlService {

	@Autowired
	private RecordTypeOfMysqlDao recordTypeOfMysqlDao;
	@Override
	public JsonResult insert(Map<String, Object> parameter) throws Exception {
		JsonResult jsonResult = new JsonResult();
		Map<String,Object> map = new HashMap<String,Object>();
		BlRecordtypeModel model = new BlRecordtypeModel();
		if (parameter.containsKey("id")) {
			model.setId(SqlUids.nextId());
		}
		int value = recordTypeOfMysqlDao.insert(model, parameter);
		map.put("data",value);
	...
	public JsonResult update(Map<String, Object> parameter) throws Exception {
		...
		Map<String,Object> map = new HashMap<String,Object>();
		BlRecordtypeModel model = new BlRecordtypeModel();
		int value = recordTypeOfMysqlDao.update(model, parameter);
		map.put("data",value);
		jsonResult.setData(map);
		jsonResult.setSuccess(true);
		return jsonResult;
	...
	public JsonResult delete(Map<String, Object> parameter) throws Exception {
		...
		Map<String,Object> map = new HashMap<String,Object>();
		BlRecordtypeModel model = new BlRecordtypeModel();
		int value = recordTypeOfMysqlDao.delete(model, parameter);
		map.put("data",value);
		jsonResult.setData(map);
		jsonResult.setSuccess(true);
		return jsonResult;
	...
	public JsonResult query(Map<String, Object> parameter) throws Exception {
		...
		map.put("data",recordTypeOfMysqlDao.query(model));
		jsonResult.setData(map);
		jsonResult.setSuccess(true);
		return jsonResult;
	}
	...
	public JsonResult queryNavigator(Map<String, Object> parameter) throws Exception {
		...
		map.put("data",recordTypeOfMysqlDao.queryNavigator(model, parameter,currentPage,pageSize));
		jsonResult.setData(map);
		jsonResult.setSuccess(true);
		return jsonResult;
	}
