...
public class RedisPoolUtils {
	...
	private static final Logger log = LoggerFactory.getLogger(RedisPoolUtils.class);
	...
	private void initJedisPool() {
		...
		jedisPool = new JedisPool(config, "192.168.5.67", 6379);
	}
	...
	public static void main(String[] args) {
		...
		String werwe = redis.set("werwe", JSON.toJSONString(map));
		System.out.println(werwe);
		String s = redis.get("werwe");
