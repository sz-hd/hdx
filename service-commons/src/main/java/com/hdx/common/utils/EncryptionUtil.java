...
public class EncryptionUtil {
	...
	public static String encrypt128(String content, String key) {    
        try {      
            /** 
...
//          return new String(Base64.encode(result));  
     ...
     * @return 
     */  
    public static String decrypt128(String content, String key) {    
        try {    
            KeyGenerator kgen = KeyGenerator.getInstance("AES");  
...
//          byte[] result = cipher.doFinal(Base64.decode(content.getBytes()));    
	...
	public static void main(String[] args) {
		try {
			...
			// 需要加密的内容  
		    String content = "accountType=0&userAccount=timchan@cherrypicks.com&device=1&password=iamtim&nickName=林国强&deviceVerNum=1.0";  
		    // 生成密钥需要的密码值  
		    String key = "KLYM_KEY_9bfb384f8c4101ce8b9";  
		    System.out.println("content： " + content + "\nkey： " + key);  
		    // 内容加密后的值  
		    String encode = encrypt128(content, key);  
		    // 被加密的内容解密后的值  
		    String decode = decrypt128(encode, key);  
