...
public class DateTimeUtil {
	...
	public static List<String> getAfterNDate2(Date date, int days) {
		SimpleDateFormat sf = new SimpleDateFormat(DATA_PATTERN_YYYYMMDD);
		List<String> list = new ArrayList<String>();
		for(int i=0;i<days;i++) {
			Calendar calendar = Calendar.getInstance();
			calendar.setTime(date);
	...
	public static String getPreYearAndMonth() throws Exception {
		Calendar cal = Calendar.getInstance();
        cal.setTime(new Date());
        cal.add(Calendar.MONTH, -1);
        Date date = cal.getTime();
        SimpleDateFormat dateFormat = new SimpleDateFormat(DATE_PATTERN_YYYYMM);
		return dateFormat.format(date);
	}
	
	public static String getCurrentYearAndMonth() throws Exception {
	...
	public static String getTimeStampOfSecond() throws Exception {
		return String.valueOf((int) (System.currentTimeMillis() / 1000)); 
	}
	
	public static String getTimeStamp() throws Exception {
		return String.valueOf((long) (System.currentTimeMillis())); 
	}
