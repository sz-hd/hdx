...
public abstract class ModelToSelect {
	 ...
	 * @throws IllegalArgumentException 
	 */
	public static  Map<String, Object> convertSelectSql(Object model, Map<String, Object> parameter,String prefix) throws Exception {
		return convertMoreModelSelectSql(model,false,parameter,1,prefix);
	}
	 ...
	 * @throws IllegalArgumentException 
	 */
	private static  Map<String, Object> convertMoreModelSelectSql(Object model,Boolean isMoreModelSelect, Map<String, Object> parameter,int level,String prefix) throws Exception {
		return modelToSelect(model,isMoreModelSelect,parameter,level,prefix);
	}
...
//		setSelectGroupBy(model,sqlSelect,map,"t","",true);
	...
	private static synchronized Map<String, Object> modelToSelect(Object model,Boolean isMoreModelSelect,Map<String,Object> parameter,int level,String prefix) throws Exception {
		StringBuffer sqlSelect = new StringBuffer();
...
//			}
		...
		/*设置查询表 */
		String stable = table.name().replaceAll("\\{PREFIX\\}", prefix);
		sqlSelect.append( stable + " t ");
		if(isMoreModelSelect){
//			for (Field field : fields) {
//				JoinTable joinTable = field.getAnnotation(JoinTable.class);
//				if(joinTable!=null){
